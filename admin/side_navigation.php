            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                    ...
                    <li class="no-padding <?php if($page_name == 'course_types.php') { echo "active"; } ?>"><a class="waves-effect waves-grey" href="course_types.php"><i class="material-icons">settings_input_svideo</i>Course Types</a></li>
                    <li class="no-padding <?php if($page_name == 'students.php') { echo "active"; } ?>"><a class="waves-effect waves-grey" href="students.php"><i class="material-icons">settings_input_svideo</i>Students</a></li>
